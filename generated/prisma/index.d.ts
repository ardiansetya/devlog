...
export namespace Prisma {
  ...
  */
	...
	interface ArticleFieldRefs {
		...
		readonly coverImageKey: FieldRef<"Article", "String">;
	...
	export type ArticleWhereInput = {
		...
		coverImageKey?: StringNullableFilter<"Article"> | string | null;
	...
	export type ArticleScalarWhereWithAggregatesInput = {
		...
		coverImageKey?:
			| StringNullableWithAggregatesFilter<"Article">
			| string
			| null;
	...
	export type ArticleUpdateManyWithWhereWithoutUserInput = {
		...
		data: XOR<
			...
			ArticleUncheckedUpdateManyWithoutUserInput
		>;
	};
